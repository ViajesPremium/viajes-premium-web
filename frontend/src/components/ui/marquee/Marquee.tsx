  ...
  ({
    ...
    const rootClassName = useMemo(
      () =>
        [
          styles.logoloop,
          isVertical ? styles.logoloopVertical : styles.logoloopHorizontal,
          fadeOut && styles.logoloopFade,
          scaleOnHover && styles.logoloopScaleHover,
          className,
        ]
          .filter(Boolean)
          .join(" "),
      ...
      (item: LogoItem, key: React.Key) => {
        ...
        const content = isNodeItem ? (
          ...
          <img
            ...
            height={item.height}
            alt={item.alt ?? ""}
            title={item.title ?? item.alt ?? "Logotipo"}
            loading="lazy"
            decoding="async"
            draggable={false}
          />
        ...
        const itemContent = item.href ? (
          <a
            ...
            title={itemAriaLabel || item.title || "logo link"}
            target="_blank"
