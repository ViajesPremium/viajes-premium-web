...
export const BARRANCAS_ITINERARIES: LandingItineraries = {
  ...
  items: [
    {
      id: 1,
      day: "5 D?AS ? CHEPE EXPRESS ? MIRADORES ? NATURALEZA ? BARRANCAS",
      ...
      ideal:
        "Ideal para parejas, familias y viajeros que buscan descubrir lo más ic?nico de Barrancas del Cobre en una experiencia cómoda, bien dise?ada y memorable.",
    ...
    {
      id: 2,
      day: "7 D?AS ? EL FUERTE ? LEYENDAS ? HISTORIA ? BARRANCAS",
    ...
    {
      id: 3,
      day: "8 D?AS ? GASTRONOM?A ? CULTURA MENONITA ? CHEPE EXPRESS ? BARRANCAS",
      title: "Sabores del Norte",
      description:
        "Una experiencia más profunda por Barrancas del Cobre, donde el paisaje tambi?n se vive a trav?s de la cocina regional, los sabores del norte, la cultura menonita y los recorridos escénicos del Chepe Express.",
      ideal:
        "Ideal para viajeros que disfrutan comer bien, conocer tradiciones locales y vivir un destino desde sus paisajes, su cultura y sus sabores más aut?nticos.",
